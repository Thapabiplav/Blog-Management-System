        ...
        <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
          ...
          <div className="divide-y divide-gray-200">
              <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                ...
                type === 'Register' && (
                  <div className="relative">
                  <input autocomplete="off" id="text" name="username" type="text" className="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Email address"  onChange={handleChange } required/>
            ...
            { type === 'Register'?( <Link to='/login' style={{color:'blue'}}>Go to Login</Link>) :
